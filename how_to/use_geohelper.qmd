...
The **GeoHelper** is a popup window that helps you entering geographic data such as the origin of the patient. It is mostly used to enter data on the patient data sheet, but it is also useful on the "Spatio-Temporal analysis" sheet.
