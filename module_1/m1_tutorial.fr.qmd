...
Nous allons dans cette partie travailler sur le fichier `linelist_rougeole_mandoul.xlsb` qui contient des données rougeole simulées^[En essayant au maximum d'utiliser les paramètres des linelists rougeoles de MSF, au moins pour les variables principales, ce qui nous évite des problèmes de confidentialité.].
