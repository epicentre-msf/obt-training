...
MSF has been working in Chad since 2006 where our teams provide medical care and assistance to displaced people and local communities, who are often struggling with a lack of food, in the east and the south of the country.

In December 2021, following several reports of measles cases in the Southern region of Mandoul, MSF and Epicentre decided to provide support and respond to the outbreak. A linelist is needed to collect patient data in structures. 
...
::: {.callout-tip}
I am a handy bit of informations that may be omitted in a first reading if you are in a hurry, but totally deserve some attention at some point.
:::
...
The linelist was deployed in January 2022; almost a year later, in April 2023, the measles outbreak is still ongoing. The linelist is used in Moissala and the neighbouring areas. You receive the file with data and you want to have a look at it.
...
1. Anaslyses need to be **refreshed** before being explored.
