...
![OutbreakTools menu in OBT linelists](../reference/images/img-002-ribbon-linelist.png){fig-align="center"}


### Data table {#sec-data-table}

![Buttons acting on data tables](../reference/images/img-006-ll-table-management.png){fig-align="center"}
...
![OutbreakTools tab in the **setup file**](../reference/images/img-003-ribbon-setup.png){#fig-setup-ribbon fig-align="center"}
...
![Table management section](../reference/images//img-003-ribbon-setup-table.png){fig-align="center"}
...
![Button to add or remove rows of diffeent analyses tables](../reference/images/im-115-table-managment.png){fig-align="center"}
...
![Button to add or remove rows of diffeent analyses tables](../reference/images/im-117-table-managment.png){fig-align="center"}
