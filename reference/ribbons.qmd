...
The "Import geobase" button allows you to import a [geobase](../how_to/import_geobase.qmd#sec-geobase-download) in the linelist. If the current linelist had already a geobase, it will be replaced.
